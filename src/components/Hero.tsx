...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* DESKTOP BADGES — ORIGINAL LEFT / RIGHT POSITIONS */}
      <div
        className="
          absolute bottom-15 left-1/2 z-20
          hidden w-full max-w-[1450px]
          -translate-x-1/2
      ...
      >
        {/* MOBILE BADGES — CENTERED ABOVE TITLE */}
        <div className="mb-3 flex items-center justify-center gap-3 md:hidden">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-black/65 px-3.5 py-2 backdrop-blur-md">
            <span className="h-2 w-2 rounded-full bg-yellow-400" />

            <span className="whitespace-nowrap text-[9px] font-medium uppercase tracking-[0.18em] text-white/80">
              EST. 2025 · BENGALURU
            </span>
          </div>
        ...
        <div className="mt-2 flex flex-col gap-3 sm:flex-row">
          ...
          <button
            ...
            className="inline-flex cursor-pointer items-center justify-center rounded-full border border-yellow-400/50 bg-black/45 px-7 py-3 text-sm font-semibold text-white transition-colors hover:bg-yellow-400/10"
          >
            Explore Instruments
          </button>
        </div>
